      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Hallo, <span class="text-black fw-bold"><?php echo $_SESSION['nama_pemilik']; ?></span></h1>
            <h3 class="welcome-sub-text">Pemilik</h3>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="../#" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <?php } else { ?>
              <img class="img-xs rounded-circle" src="../images/faces/<?php echo $foto_pemilik; ?>" alt="Profile image" >
              <?php } ?>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <img class="img-xs rounded-circle" src="../images/faces/<?php echo $foto_pemilik; ?>" alt="Profile image" >
                <?php } ?>
                <p class="mb-1 mt-3 font-weight-semibold"><?php echo $_SESSION['nama_pemilik']; ?></p>
                <p class="fw-light text-muted mb-0">Pemilik</p>
              </div>
              <a class="dropdown-item" href="profil_pemilik.php"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i>Profil Saya</a>
      ...
      <div class="modal-dialog modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="../logout_pemilik.php" class="btn btn-inverse-danger">Keluar</a>
