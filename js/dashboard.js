  ...
  $(function() {
          ...
          scales: {
              ...
              xAxes: [{
                ...
                ticks: {
                  beginAtZero: true,
                  callback: function(value, index, values) {
                      return value.toLocaleString('id-ID'); // Menampilkan 100.000 dst.
                  },
                  maxTicksLimit: 7,
                  fontSize: 10,
                  color:"#6B778C"
    ...
    if ($('#totalVisitors').length) {
      var bar = new ProgressBar.Circle(totalVisitors, {
        ...
        from: {
          color: '#FF6B6B', // Merah untuk belum lunas
          width: 15
        },
        to: {
          color: '#FF0000',
      ...
      bar.animate(persentaseBelumLunas);
    }
    ...
    if ($('#visitperday').length) {
      var bar = new ProgressBar.Circle(visitperday, {
        ...
        from: {
          color: '#34B1AA', // Hijau untuk lunas
          width: 15
        },
        to: {
          color: '#00FF66',
    ...
    if ($("#doughnutChart").length) {
      ...
      var doughnutPieOptions = {
        ...
        legendCallback: function (chart) {
          var text = [];
          text.push('<div class="chartjs-legend d-flex flex-wrap justify-content-center">');
          for (var i = 0; i < chart.data.datasets[0].data.length; i++) {
            text.push('<div class="d-flex align-items-center mx-2 my-1" style="min-width: 120px;">');
            text.push('<span style="display:inline-block;width:12px;height:12px;margin-right:5px;background-color:' + chart.data.datasets[0].backgroundColor[i] + '"></span>');
